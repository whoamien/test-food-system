...
export class FoodController {
	...
	async list(req: Request, res: Response): Promise<Response> {
		const { search, categoryId, restaurantId, available, minPrice, maxPrice, status, page, pageSize } = req.query;
	...
	async create(req: Request, res: Response): Promise<Response> {
		...
		const { name, description, price, categoryId, restaurantId, image_url, available } = req.body;
	...
	async update(req: Request, res: Response): Promise<Response> {
		...
		const id = Number(req.params.id);
		const { name, description, price, categoryId, restaurantId, image_url, available, status } = req.body;
